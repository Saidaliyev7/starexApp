...
import { ITableSearch } from '../models';

const TableSearch: React.FC<{ tableSearch: ITableSearch; onSearchAddClick? }> = React.memo(
    ({ tableSearch, onSearchAddClick }) => {
        return (
            <>
                        ...
                        <div className="right">
                            <div className="new-add">
                                <button onClick={onSearchAddClick}>
                                    ...
                                    <div className="text">{tableSearch.isNewAddText}</div>
                                </button>
                            </div>
                        </div>
                    )}
