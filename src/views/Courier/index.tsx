...
const Courier: React.FC = () => {
    ...
    const [isAdd, changeAdd] = React.useState<boolean>(false);
    React.useEffect(() => {
        ...
        <>
            {isAdd ? (
                <Table
                    ...
                    onSearchAddClick={onCourierAddClick}
                    tableData={tableData}
                >
                    {!isTabletOrMobile ? (
                        <TableBody>
                        ...
                        <>
                            {tableData?.tbodyData.map((data) => (
                                <TableCard key={data.id}>
                                    ...
                                    <div
                                        className="card-data-upper"
                                        onClick={
                                            tableData.checkComponent && data.buyStatus === 'pending'
                                                ? () => onTdClick(data)
                                                : null
                                        }
                                    >
